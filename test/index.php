...
<nav class="navbar navbar-expand-lg navbar-light sticky-top " id="navbar">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="./img/Group 61.png" class="img-fluid my-5 md-float-start" alt="">
        </a>
        ...
        <div class="collapse navbar-collapse flex justify-content-lg-end " id="navbarNav">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link rounded border-0  my-md-5 my-1  mx-2 p-2  text-light fw-medium" data-bs-toggle="modal" data-bs-target="#exampleModal">
